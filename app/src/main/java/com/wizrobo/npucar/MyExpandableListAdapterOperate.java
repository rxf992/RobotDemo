...
public class MyExpandableListAdapterOperate extends BaseExpandableListAdapter
{
    private Context mContext;
    private List<String> expandableListTitle;
    private HashMap<String, List<String>> expandableListDetail;

    public MyExpandableListAdapterOperate(List<String> expandableListTitle, HashMap<String,List<String>> expandableListDetail, Context mContext)
    {
                             ...
                             boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        if(WizRoboNpu.isTrack) {
            ...
            if (groupPosition == 1 && childPosition == 0 && WizRoboNpu.isTrack) {
            ...
            if (groupPosition == 2 && childPosition == 0 && WizRoboNpu.isTrack) {
                data = WizRoboNpu.strModifyPathXY;
                if (WizRoboNpu.toModifyPath)
                    tv.setTextColor(Color.rgb(207, 42, 48));
            ...
            if (groupPosition == 2 && childPosition == 1 && WizRoboNpu.isTrack) {
                data = WizRoboNpu.strModifyPathYaw;
                if (WizRoboNpu.toModifyPathYaw)
                    tv.setTextColor(Color.rgb(207, 42, 48));
